            ...
            <div class="h-max bg-white rounded-lg shadow-lg border border-gray-300">
                ...
                <div class="p-2">
                    ...
                    <div id="{{ $photo->id }}" class="hidden">
                        <form action="{{ route('comments.store', $photo->id) }}" method="post" class="commentForm" data-photo_id="{{ $photo->id }}">
                            @csrf
                            <div class="flex items-center px-2 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
                                <textarea name="comment" rows="1" class="textarea block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Add a comment..."></textarea>
